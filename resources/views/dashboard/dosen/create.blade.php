                    ...
                    <form action="/dashboard/dosen" method="POST">
                       ...
                       <div class="modal-body">
                               ...
                               <div class="row mb-3">
                                   ...
                                   <div class="col-sm-10">
                                       <input class="form-control  @error('nama') is-invalid @enderror" type="text" value="{{ old('nama') }}" placeholder="" name="nama" id="example-text-input">
                                       @error('nama')
                                           <div class="invalid-feedback">
                                               {{ $message }}
                                           </div>
                               ...
                               <div class="row mb-3">
                                   ...
                                   <div class="col-sm-10">
                                       <input class="form-control @error('no_telepon') is-invalid @enderror" type="text" placeholder="" name="no_telepon" type="text" value="{{ old('no_telepon') }}" id="example-text-input">
                                       @error('no_telepon')
                                           <div class="invalid-feedback">
                                               {{ $message }}
                                           </div>
                                   ...
                                   <label for="example-text-input" class="col-sm col-form-label">Fakultas</label>
                                       <div class="col-sm-10">
                                           <select class="form-select" name="fakultas" aria-label="Default select example">
                                               ...
                                               <option  {{ old('fakultas') == "fti" ?  'selected' : ''}} value="fti">Fakultas Teknologi Informasi</option>
                                               <option  {{ old('fakultas') == "fkdk" ?  'selected' : ''}} value="fkdk">Fakultas Komunikasi dan Desain Kreatif</option>
                                               <option  {{ old('fakultas') == "feb" ?  'selected' : ''}} value="feb">Fakultas Ekonomi dan Bisnis</option>
                                               <option  {{ old('fakultas') == "fissig" ?  'selected' : ''}} value="fissig">Fakultas Ilmu Sosial dan Ilmu Politik</option>
                                               <option  {{ old('fakultas') == "ft" ?  'selected' : ''}} value="ft">Fakultas Teknik</option>
                                            </select>
                                            @error('fakultas')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
